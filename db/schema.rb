...
ActiveRecord::Schema.define(version: 20170612222620) do
  ...
  create_table "familysitters", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["family_id"], name: "index_familysitters_on_family_id", using: :btree
    t.index ["sitter_id"], name: "index_familysitters_on_sitter_id", using: :btree
  end
